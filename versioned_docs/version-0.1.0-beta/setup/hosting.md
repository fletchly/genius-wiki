...
2. **Configure the plugin:**
   ...
   - Set `ollama.baseUrl` to `https://ollama.com/`
   - Set `ollama.apiKey` to your API key from step 1
   - _(Optional)_ Change `ollama.model` to a different [cloud model](https://docs.ollama.com/cloud#cloud-models) (default is `deepseek-v3.1:671b`)
...
2. **Configure the plugin:**
   ...
   - Set `ollama.model` to your desired model
